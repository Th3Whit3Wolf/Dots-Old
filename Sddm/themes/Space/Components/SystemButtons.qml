            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        ...
                        palette.buttonText: Qt.lighter(config.AccentColor, 1.1)
                    }
                    PropertyChanges {
                ...
                State {
                    ...
                    PropertyChanges {
                        target: parent.children[index]
                        palette.buttonText: Qt.lighter(config.AccentColor, 1.5)
                    }
                    PropertyChanges {
                        target: parent.children[index].background
                        border.color: Qt.lighter(config.AccentColor, 1.7)
                    }
                },
                State {
                    name: "focused"
                    ...
                    PropertyChanges {
                        target: parent.children[index]
                        palette.buttonText: Qt.lighter(config.AccentColor, 1.3)
                    }
                    PropertyChanges {
                        target: parent.children[index].background
                        border.color: Qt.lighter(config.AccentColor, 1.5)
                    }
                }
            ]
